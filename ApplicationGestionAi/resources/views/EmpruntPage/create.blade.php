...
@section('title', 'Nouvel Emprunt - Bib Readers')
        ...
        <div class="bg-white rounded-xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
                <div class="flex items-center">
                    ...
                    <h2 class="text-2xl font-bold text-white">Détails de l'emprunt</h2>
                </div>
            </div>
            ...
            <div class="p-6">
                ...
                <form action="{{ route('emprunts.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 pt-4">
                        <button type="submit" class="flex-1 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white px-8 py-3 rounded-lg font-semibold transition-all duration-200 transform hover:scale-105 shadow-lg">
