        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-4">
                    🤖 Découvrez vos prochaines lectures avec l'IA
                </h2>
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Parlez-nous des livres que vous avez aimés et notre intelligence artificielle vous proposera des recommandations personnalisées.
                </p>
            </div>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-2xl shadow-xl p-8">
                    <form id="personalRecommendationForm" class="space-y-6">
                        @csrf
                ...
                <div id="loadingSection" class="hidden bg-white rounded-2xl shadow-xl p-8 text-center mt-8">
                ...
                <div id="resultsSection" class="hidden mt-8">
                    <div class="bg-white rounded-2xl shadow-xl p-8">
                        <div class="text-center mb-8">
                            <h3 class="text-2xl font-bold text-gray-900 mb-2">🎯 Vos recommandations personnalisées</h3>
                ...
                <!-- Section d'erreur -->
                <div id="errorSection" class="hidden bg-red-50 border border-red-200 rounded-2xl p-8 text-center mt-8">
...
function resetForm() {
    ...
    document.querySelector('.bg-white.rounded-2xl.shadow-xl.p-8').style.display = 'block';
}
